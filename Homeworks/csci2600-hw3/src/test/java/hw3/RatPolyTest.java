...
public final class RatPolyTest {
  ...
  public void testGetTerm() {
    ...
    assertEquals(RatNum.ZERO, _XSqPlus2X.getCoeff(-1));
    assertEquals(RatNum.ZERO, _XSqPlus2X.getCoeff(-10));
    assertEquals(RatNum.ZERO, _2XSqPlusX.getCoeff(-1));
    assertEquals(RatNum.ZERO, _2XSqPlusX.getCoeff(-10));
    assertEquals(RatNum.ZERO, zero().getCoeff(-10));
    assertEquals(RatNum.ZERO, zero().getCoeff(-1));
  }
  ...
  @Test // Constant Rule with zero f(x) = 0 => F = c
    ...
    public void testAntiDifferentiateConstantMultipleRule() {
      ...
      assertEquals(((a_constant).mul(poly1)).antiDifferentiate(i_constant), 
           a_constant.mul(poly1.antiDifferentiate(RatNum.ZERO)).add(new RatPoly(new RatNum[] {i_constant})));
    ...
    public void testAntiDifferentiateSumRule() {
      ...
      assertEquals((neg_poly3.add(neg_poly1)).antiDifferentiate(RatNum.valueOf("3")), 
          ...
          .add(new RatPoly(new RatNum[] {RatNum.valueOf("3")})));
    }
