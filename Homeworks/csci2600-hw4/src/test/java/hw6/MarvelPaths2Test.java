...
public final class MarvelPaths2Test{
	...
	private static MarvelPaths2 test = new MarvelPaths2();
	...
	public void testLinetemp(){
		...
		String expected = "path from " + "A" + " to " + "D" + ":\n"
						...
						+ "total cost: 3.000" + "\n";
		//System.out.println(test.findPath("A", "D"));
	...
	public void testCharacterAlphabetical(){
		...
		String expected = "path from X to Y:\nX to A with weight " + "1"
						+ "\nA to Y with weight " + "2" + "\n";
